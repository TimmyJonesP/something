...
interface ProfilePageClientProps {
  ...
  likedPosts: Awaited<ReturnType<typeof getUserLikedPosts>>;
  isFollowing: Awaited<ReturnType<typeof isFollowing>>;
}
...
function ProfilePageClient({
  ...
  const handleEditSubmit = async () => {
    ...
    if (result.success) {
      ...
      toast.success("Something has changed! It could be your profile!!");
    }
  };
  ...
  const handleFollow = async () => {
    ...
    try {
      ...
      toast.success("Something has changed! Maybe you're following someone!!");
    } catch (error) {
